...
const vec4 CURRENT_COLOR = vec4(0.706, 0.745, 0.996, 1.0);
const vec4 PREVIOUS_COLOR = vec4(0.957, 0.957, 0.957, 1);
const vec4 TRAIL_COLOR = vec4(0.957, 0.957, 0.957, 1.0);
